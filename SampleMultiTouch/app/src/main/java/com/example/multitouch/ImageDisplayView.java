...
public class ImageDisplayView extends View implements View.OnTouchListener {
    ...
    private void scaleImage(float inScaleRation){
        Log.d(TAG, "scaleImage() called : " + inScaleRation);

        mMatrix.postScale(inScaleRation, inScaleRation, bitmapCenterX, bitmapCenterY);
        mMatrix.postRotate(0);

        totalScaleRatio = totalScaleRatio * inScaleRation;
